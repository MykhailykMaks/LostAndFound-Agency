...
{
    public class LostRequestViewModel : ViewModelBase
    {
        ...
        public LostRequestViewModel(Person currentClient)
        {
        ...
        private void ExecuteSave(object? obj)
        {
            ...
            var request = new LostRequest
            {
                PersonId = _currentClient.PersonId,
            ...
            _clientService.AddLostRequest(request);
            OnSuccess?.Invoke();
        }
    }
}
